        ...
        for i, cmd in enumerate(self.commands, start=1):
            ...
            try:
                if is_windows:
                    ...
                    # Run bash commands on Linux/macOS
                    proc = subprocess.Popen(
                        cmd,
                        shell=True,
                        executable="/bin/bash",
...
class TaskWidget(QWidget):
    def __init__(self, index: int, task: dict):
        ...
        self.setMouseTracking(True)  # Important for hover
        ...
        self.default_border = "#ffffff"  # white against dark blue
    ...
    def set_valid(self, is_valid: bool):
        ...
        self.status_label.setStyleSheet(f"border-radius:9px; background-color:{color};")
...
class MainWindow(QMainWindow):
    ...
    def on_finished(self):
        ...
        self.enable_ui()
        QMessageBox.information(self, "Done ✅", "All commands have finished running.")
